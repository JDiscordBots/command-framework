...
If it is a security vulnerability, please don't create an issue on github but submit it as fast as possible (see the [Security Policy](https://github.com/JDiscordBots/command-framework/blob/master/.github/SECURITY.md)).
